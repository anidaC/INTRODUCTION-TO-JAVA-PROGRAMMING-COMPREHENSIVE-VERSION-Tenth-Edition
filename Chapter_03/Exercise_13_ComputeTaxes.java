 ...
 *  to compute taxes for single filers. Complete Listing 3.5 to compute the taxes for all 
 *  filing statuses.
 *
 */

public class Exercise_13_ComputeTaxes {
	...
	public static void main(String[] args) {
		...
		// Display the result
		System.out.printf("Tax is %6.2f", ((tax * 100) / 100.0));
